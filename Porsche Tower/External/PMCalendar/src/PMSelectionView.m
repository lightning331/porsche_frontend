...
//                                     , floor((thisRowEndCell - thisRowStartCell + 1) * (hDiff)) - 4, vDiff - 4);
            CGRect rect = CGRectMake(innerPadding.width + floor(thisRowStartCell*hDiff) + 1.5
                                     , headerHeight + innerPadding.height + ceil(i*vDiff + vDiff*0.25) + 2
                                     , floor((thisRowEndCell - thisRowStartCell + 1) * (hDiff)) - 4, vDiff - 4);
//            UIBezierPath* selectedRectPath = [UIBezierPath bezierPathWithRoundedRect:rect cornerRadius: 10];
            UIBezierPath* selectedRectPath = [UIBezierPath bezierPathWithRoundedRect:rect cornerRadius: 0];
...
//            [darkColor setStroke];
            [[UIColor colorWithRed: 3.0/255 green: 127.0/255 blue: 216.0/255 alpha: 1] setStroke];
