...
//    self.monthPicker.frame = CGRectMake(0, (self.frame.size.height - 216) / 2, monthPickerWidth, 216);
    self.monthPicker.frame = CGRectMake(0, 0, monthPickerWidth, self.frame.size.height);
