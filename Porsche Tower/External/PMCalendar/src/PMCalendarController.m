...
- (void) initializeWithSize:(CGSize) size
{
    if ([[UIDevice currentDevice].model containsString:@"iPad"]) {
        monthPickerWidth = 200.0f;
    }
    else {
        monthPickerWidth = 150.0f;
    }
...
//                                                                                      , outerPadding.width
//                                                                                      , outerPadding.height)];
    self.backgroundView = [[PMCalendarBackgroundView alloc] initWithFrame:CGRectMake(monthPickerWidth, 0, calendarRectWithArrowInsets.size.width - monthPickerWidth, calendarRectWithArrowInsets.size.height)];
    ...
    self.digitsView = [[PMCalendarView alloc] initWithFrame:CGRectInset(calendarRect
                                                                        , innerPadding.width
                                                                        , innerPadding.height)];
//    self.digitsView = [[PMCalendarView alloc] initWithFrame:CGRectInset(CGRectMake(monthPickerWidth, 0, size.width - monthPickerWidth, size.height)
//                                                                        , innerPadding.width
//                                                                        , innerPadding.height)];
...
//                         animated:animated];
    [self presentCalendarFromRect:CGRectMake(0, 0, 0, 0)
                           inView:self.anchorView
         permittedArrowDirections:arrowDirections
                         animated:animated];
}
