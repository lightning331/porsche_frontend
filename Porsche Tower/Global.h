...
#define SUBCATEGORY_ARRAY @[@[NSLocalizedString(@"title_request_car_elevator", nil), NSLocalizedString(@"title_schedule_car_elevator", nil), NSLocalizedString(@"title_scheduled_pickups", nil)], \
                            ...
                            @[NSLocalizedString(@"title_warranties", nil), NSLocalizedString(@"title_owners_manual", nil), NSLocalizedString(@"title_contractors_manual", nil), NSLocalizedString(@"title_condominium_documents", nil), NSLocalizedString(@"title_authorization_forms", nil)], \
